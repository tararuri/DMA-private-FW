...
module pcileech_fifo #(
    ...
    reg     [79:0]      _pcie_core_config = { 4'hf, 1'b1, 1'b1, 1'b0, 1'b0, 8'h02, 16'h8168, 16'h10EC, 16'h8168, 16'h10EC };
    ...
    task pcileech_fifo_ctl_initialvalues;               // task is non automatic
        begin
            ...
            rw[143:128] <= 16'h10EC;                    // +010: CFG_SUBSYS_VEND_ID (NOT IMPLEMENTED)
            rw[159:144] <= 16'h0007;                    // +012: CFG_SUBSYS_ID      (NOT IMPLEMENTED)
            rw[175:160] <= 16'h10EC;                    // +014: CFG_VEND_ID        (NOT IMPLEMENTED)
            rw[191:176] <= 16'h1533;                    // +016: CFG_DEV_ID         (NOT IMPLEMENTED)
